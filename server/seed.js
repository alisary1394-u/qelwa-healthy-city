...
/** اللجان حسب الملحق الثاني من دليل معايير المدن الصحية (منظمة الصحة العالمية) */
const COMMITTEES = [
  { name: 'اللجنة الرئيسية', description: 'اللجنة الرئيسية التي تنبثق منها جميع لجان المدينة الصحية' },
  { name: 'لجنة بناء الشراكات من أجل التنمية المحلية', description: 'بناء الشراكات من أجل التنمية المحلية' },
  { name: 'لجنة مركز المعلومات والمشاركة المجتمعية', description: 'مركز المعلومات والمشاركة المجتمعية' },
  { name: 'لجنة البيئة والاستدامة', description: 'البيئة والاستدامة' },
  { name: 'لجنة الصحة والرعاية الصحية', description: 'الصحة والرعاية الصحية' },
  { name: 'لجنة الصحة والرعاية والوقاية', description: 'الصحة والرعاية والوقاية' },
  { name: 'لجنة السلامة والأمان والعدالة الاجتماعية', description: 'السلامة والأمان والعدالة الاجتماعية' },
  { name: 'لجنة الطوارئ والتعليم والثقافة', description: 'الطوارئ والتعليم والثقافة' },
  { name: 'لجنة التدريب والمهارات', description: 'التدريب والمهارات' },
  { name: 'لجنة الاقتصاد والإقراض', description: 'الاقتصاد والإقراض' },
];
/** المحاور التسعة حسب الملحق الثاني – معايير المدن الصحية (منظمة الصحة العالمية) */
const AXES = [
  'بناء الشراكات من أجل التنمية المحلية',
  'مركز المعلومات والمشاركة المجتمعية',
  'البيئة والاستدامة',
  'الصحة والرعاية الصحية',
  'الصحة والرعاية والوقاية',
  'السلامة والأمان والعدالة الاجتماعية',
  'الطوارئ والتعليم والثقافة',
  'التدريب والمهارات',
  'الاقتصاد والإقراض',
];
