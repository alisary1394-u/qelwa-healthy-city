...
export async function runSeed(options = {}) {
  ...
  if (db.list('family_survey').length === 0) {
    ...
    const volunteerNames = volunteers.length > 0
      ...
      : ['متطوع حي الشفاء', 'متطوع حي الخالدية', 'متطوع حي الصفاء', 'متطوع حي النسيم', 'متطوعة حي العزيزية', 'متطوعة حي الشروق'];
    const districts = ['حي الشفاء', 'حي الخالدية', 'حي الصفاء', 'حي النسيم', 'حي العزيزية', 'حي الشروق', 'حي الشفاء', 'حي الخالدية', 'حي الصفاء', 'حي النسيم', 'حي العزيزية', 'حي الشروق'];
    const familyHeads = [
