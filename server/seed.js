...
/** المحاور الـ 12 حسب ملف المعايير CSV (8+8+8+5+5+10+8+4+4+6+6+8=80) */
const AXES = [
...
/** عدد المعايير لكل محور (12 محوراً) */
const AXIS_COUNTS = [8, 8, 8, 5, 5, 10, 8, 4, 4, 6, 6, 8];
