 ...
 * 12 محوراً، 75 معياراً، مع مؤشرات أداء لكل معيار ولكل محور.
 */

/** توزيع المعايير على المحاور الـ 12 (7+7+5+5+5+10+8+4+4+6+6+8 = 75) — المحور 3 (ج): مركز المعلومات المجتمعي (5) */
export const AXIS_COUNTS_CSV = [7, 7, 5, 5, 5, 10, 8, 4, 4, 6, 6, 8];
...
export const AXES_CSV = [
  ...
  { name: 'القروض الصغيرة', description: 'القروض الصغيرة (معايير 20–24)', order: 4 },
  { name: 'التعليم ومحو الأمية', description: 'التعليم ومحو الأمية (معايير 25–29)', order: 5 },
  { name: 'التنمية الصحية', description: 'التنمية الصحية (معايير 30–39)', order: 6 },
  { name: 'المياه والصرف الصحي والبيئة', description: 'المياه والصرف الصحي والبيئة (معايير 40–47)', order: 7 },
  { name: 'الغذاء والبيئة', description: 'الغذاء والبيئة (معايير 48–51)', order: 8 },
  { name: 'سلامة الأغذية', description: 'سلامة الأغذية (معايير 52–55)', order: 9 },
  { name: 'تخطيط الطوارئ', description: 'تخطيط الطوارئ (معايير 56–61)', order: 10 },
  { name: 'السلامة العامة', description: 'السلامة العامة (معايير 62–67)', order: 11 },
  { name: 'الرصد والتقييم', description: 'الرصد والتقييم (معايير 68–75)', order: 12 },
];
...
/**
 * المعايير الـ 75 من CSV مع عنوان، وصف، مستندات مطلوبة، مؤشرات أداء.
...
export const STANDARDS_CSV = [
  ...
  // المحور 4: القروض الصغيرة (20–24)
  { title: 'وجود نظام للقروض الصغيرة لدعم الأسر الفقيرة', axis_name: 'القروض الصغيرة', global_num: 20, axis_order: 4, kpis: [{ ...VERIFICATION_KPI, description: 'نظام قروض صغيرة' }, { name: 'عدد المستفيدين', target: '-', unit: 'أسرة' }], documents: ['نظام القروض'] },
  { title: 'استهداف النساء والشباب في مشاريع توليد الدخل', axis_name: 'القروض الصغيرة', global_num: 21, axis_order: 4, kpis: [{ ...VERIFICATION_KPI, description: 'استهداف نساء وشباب' }, { name: 'نسبة الاستهداف', target: '50%+', unit: '%' }], documents: ['سجل المستفيدين'] },
  { title: 'توفير تدريب مهني للمستفيدين من القروض', axis_name: 'القروض الصغيرة', global_num: 22, axis_order: 4, kpis: [{ ...VERIFICATION_KPI, description: 'تدريب مهني للمستفيدين' }, { name: 'نسبة المستفيدين المدربين', target: '80%+', unit: '%' }], documents: ['سجل التدريب'] },
  { title: 'نسبة استرداد القروض تتجاوز 90%', axis_name: 'القروض الصغيرة', global_num: 23, axis_order: 4, kpis: [{ ...VERIFICATION_KPI, description: 'استرداد القروض' }, { name: 'نسبة الاسترداد', target: '90%+', unit: '%' }], documents: ['تقارير السداد'] },
  { title: 'استخدام أرباح القروض في مشاريع تنموية مجتمعية', axis_name: 'القروض الصغيرة', global_num: 24, axis_order: 4, kpis: [{ ...VERIFICATION_KPI, description: 'أرباح للمشاريع المجتمعية' }, { name: 'نسبة الإعادة للتنمية', target: '5–10%', unit: '%' }], documents: ['سجل الاستخدام'] },
  // المحور 5: التعليم ومحو الأمية (30–34)
  { title: 'نسبة التحاق الأطفال بالتعليم الابتدائي (بنين وبنات) تصل لـ 100%', axis_name: 'التعليم ومحو الأمية', global_num: 25, axis_order: 5, kpis: [{ ...VERIFICATION_KPI, description: 'الالتحاق بالتعليم الابتدائي' }, { name: 'نسبة الالتحاق', target: '100%', unit: '%' }], documents: ['إحصائيات الالتحاق'] },
  { title: 'تنفيذ برامج لمحو أمية الكبار (خاصة النساء)', axis_name: 'التعليم ومحو الأمية', global_num: 26, axis_order: 5, kpis: [{ ...VERIFICATION_KPI, description: 'برامج محو أمية الكبار' }, { name: 'عدد المستفيدين', target: '-', unit: 'شخص' }], documents: ['تقارير البرامج'] },
  { title: 'توفر بيئة مدرسية صحية (مياه شرب آمنة وصرف صحي)', axis_name: 'التعليم ومحو الأمية', global_num: 27, axis_order: 5, kpis: [{ ...VERIFICATION_KPI, description: 'بيئة مدرسية صحية' }, { name: 'نسبة المدارس المطابقة', target: '90%+', unit: '%' }], documents: ['تقارير التقييم'] },
  { title: 'إدراج المفاهيم الصحية والبيئية في الأنشطة اللامنهجية', axis_name: 'التعليم ومحو الأمية', global_num: 28, axis_order: 5, kpis: [{ ...VERIFICATION_KPI, description: 'مفاهيم صحية وبيئية في الأنشطة' }, { name: 'عدد الأنشطة', target: '4+ سنوياً', unit: 'نشاط' }], documents: ['خطة الأنشطة'] },
  { title: 'متابعة المتسربين من التعليم وإعادتهم للمدارس', axis_name: 'التعليم ومحو الأمية', global_num: 29, axis_order: 5, kpis: [{ ...VERIFICATION_KPI, description: 'متابعة المتسربين وإعادتهم' }, { name: 'نسبة التسرب', target: 'صفر أو متناقص', unit: '%' }], documents: ['سجل المتابعة'] },
  // المحور 6: التنمية الصحية (35–44)
  { title: 'نسبة التغطية بالتحصينات الأساسية للأطفال تتجاوز 95%', axis_name: 'التنمية الصحية', global_num: 30, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'تغطية التحصينات' }, { name: 'نسبة التغطية', target: '95%+', unit: '%' }], documents: ['سجل التحصين'] },
  { title: 'توفر رعاية ما قبل الولادة لجميع الحوامل', axis_name: 'التنمية الصحية', global_num: 31, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'رعاية ما قبل الولادة' }, { name: 'نسبة الحوامل المستفيدات', target: '90%+', unit: '%' }], documents: ['سجل الرعاية'] },
  { title: 'وجود نظام لمتابعة نمو الأطفال وحالات سوء التغذية', axis_name: 'التنمية الصحية', global_num: 32, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'نظام متابعة النمو وسوء التغذية' }, { name: 'نسبة التغطية', target: '80%+', unit: '%' }], documents: ['تقارير المتابعة'] },
  { title: 'تشجيع الرضاعة الطبيعية الخالصة لمدة 6 أشهر', axis_name: 'التنمية الصحية', global_num: 33, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'الرضاعة الطبيعية 6 أشهر' }, { name: 'نسبة الامتثال', target: '60%+', unit: '%' }], documents: ['تقارير التوعية'] },
  { title: 'توفر خدمات تنظيم الأسرة والمشورة الصحية', axis_name: 'التنمية الصحية', global_num: 34, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'تنظيم أسرة ومشورة صحية' }, { name: 'توفر الخدمات', target: 'متحقق', unit: '-' }], documents: ['قائمة الخدمات'] },
  { title: 'مكافحة التدخين في الأماكن العامة والمرافق الحكومية', axis_name: 'التنمية الصحية', global_num: 35, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'مكافحة التدخين' }, { name: 'نسبة الامتثال', target: '90%+', unit: '%' }], documents: ['نظام الحظر', 'تقارير الرصد'] },
  { title: 'تنفيذ برامج للتوعية بالأمراض غير السارية (السكري، الضغط)', axis_name: 'التنمية الصحية', global_num: 36, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'توعية بالأمراض غير السارية' }, { name: 'عدد البرامج', target: '2+ سنوياً', unit: 'برنامج' }], documents: ['خطة البرامج'] },
  { title: 'توفر خدمات الصحة النفسية على مستوى المجتمع', axis_name: 'التنمية الصحية', global_num: 37, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'خدمات الصحة النفسية' }, { name: 'توفر الخدمة', target: 'متحقق', unit: '-' }], documents: ['وصف الخدمات'] },
  { title: 'مكافحة الأمراض المعدية وتفعيل نظام الترصد الوبائي', axis_name: 'التنمية الصحية', global_num: 38, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'ترصد وبائي ومكافحة معدية' }, { name: 'انتظام التبليغ', target: 'دوري', unit: '-' }], documents: ['تقارير الترصد'] },
  { title: 'دعم حقوق الأشخاص ذوي الإعاقة ودمجهم مجتمعياً', axis_name: 'التنمية الصحية', global_num: 39, axis_order: 6, kpis: [{ ...VERIFICATION_KPI, description: 'دعم ذوي الإعاقة والدمج' }, { name: 'نسبة المستفيدين', target: 'مقيس', unit: '%' }], documents: ['برامج الدعم'] },
  // المحور 7: المياه والصرف الصحي والبيئة (45–52)
  { title: 'وصول المياه الصالحة للشرب لجميع المنازل', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 40, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'مياه شرب لجميع المنازل' }, { name: 'نسبة التغطية', target: '90%+', unit: '%' }], documents: ['تقارير التغطية'] },
  { title: 'توفر نظام آمن للتخلص من الفضلات البشرية (صرف صحي)', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 41, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'صرف صحي آمن' }, { name: 'نسبة التغطية', target: '90%+', unit: '%' }], documents: ['خرائط الصرف'] },
  { title: 'وجود نظام دوري لجمع ومعالجة النفايات الصلبة', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 42, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'جمع ومعالجة النفايات' }, { name: 'نسبة المعالجة', target: '80%+', unit: '%' }], documents: ['تقارير المعالجة'] },
  { title: 'مكافحة الحشرات والقوارض في الأحياء السكنية', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 43, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'مكافحة حشرات وقوارض' }, { name: 'دورية الحملات', target: 'منتظم', unit: '-' }], documents: ['سجل الحملات'] },
  { title: 'زيادة المساحات الخضراء والحدائق العامة', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 44, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'مساحات خضراء وحدائق' }, { name: 'نسبة المساحات', target: 'ضمن المعايير', unit: '%' }], documents: ['خرائط المساحات'] },
  { title: 'مراقبة جودة الهواء وتقليل التلوث الصناعي', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 45, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'جودة الهواء وتقليل التلوث' }, { name: 'دورية الرصد', target: 'منتظم', unit: '-' }], documents: ['تقارير جودة الهواء'] },
  { title: 'حماية مصادر المياه من التلوث', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 46, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'حماية مصادر المياه' }, { name: 'توثيق الحماية', target: 'متحقق', unit: '-' }], documents: ['خطة الحماية'] },
  { title: 'نظافة الشوارع والأسواق العامة', axis_name: 'المياه والصرف الصحي والبيئة', global_num: 47, axis_order: 7, kpis: [{ ...VERIFICATION_KPI, description: 'نظافة الشوارع والأسواق' }, { name: 'مؤشر النظافة', target: 'مقبول+', unit: '-' }], documents: ['تقارير النظافة'] },
  // المحور 8: الغذاء والبيئة (53–56)
  { title: 'تطبيق معايير السلامة الصحية في المطاعم والمنشآت الغذائية', axis_name: 'الغذاء والبيئة', global_num: 48, axis_order: 8, kpis: [{ ...VERIFICATION_KPI, description: 'سلامة المطاعم والمنشآت' }, { name: 'نسبة الامتثال', target: '80%+', unit: '%' }], documents: ['تقارير التفتيش'] },
  { title: 'توفر أغذية صحية وبأسعار معقولة في الأسواق', axis_name: 'الغذاء والبيئة', global_num: 49, axis_order: 8, kpis: [{ ...VERIFICATION_KPI, description: 'أغذية صحية وأسعار معقولة' }, { name: 'توفر المنتجات', target: 'مقيس', unit: '-' }], documents: ['مسوحات الأسواق'] },
  { title: 'مراقبة متبقيات المبيدات في الخضروات والفواكه', axis_name: 'الغذاء والبيئة', global_num: 50, axis_order: 8, kpis: [{ ...VERIFICATION_KPI, description: 'مراقبة متبقيات المبيدات' }, { name: 'دورية الفحوص', target: 'دوري', unit: '-' }], documents: ['تقارير المختبر'] },
  { title: 'تنفيذ برامج توعوية حول العادات الغذائية الصحية', axis_name: 'الغذاء والبيئة', global_num: 51, axis_order: 8, kpis: [{ ...VERIFICATION_KPI, description: 'توعية بالعادات الغذائية' }, { name: 'عدد البرامج', target: '2+ سنوياً', unit: 'برنامج' }], documents: ['خطة التوعية'] },
  // المحور 9: سلامة الأغذية (57–60)
  { title: 'وجود نظام للتفتيش الدوري على المحلات التجارية والمسالخ', axis_name: 'سلامة الأغذية', global_num: 52, axis_order: 9, kpis: [{ ...VERIFICATION_KPI, description: 'تفتيش دوري على المحلات والمسالخ' }, { name: 'دورية التفتيش', target: 'منتظم', unit: '-' }], documents: ['سجل التفتيش'] },
  { title: 'تدريب متداولي الأغذية على أسس النظافة الشخصية', axis_name: 'سلامة الأغذية', global_num: 53, axis_order: 9, kpis: [{ ...VERIFICATION_KPI, description: 'تدريب متداولي الأغذية' }, { name: 'نسبة المدربين', target: '80%+', unit: '%' }], documents: ['سجل التدريب'] },
  { title: 'التخلص السليم من الأغذية المنتهية الصلاحية أو التالفة', axis_name: 'سلامة الأغذية', global_num: 54, axis_order: 9, kpis: [{ ...VERIFICATION_KPI, description: 'التخلص السليم من الأغذية التالفة' }, { name: 'توثيق الإجراء', target: 'متحقق', unit: '-' }], documents: ['بروتوكول التخلص'] },
  { title: 'إجراء فحوصات مخبرية دورية لعينات الغذاء', axis_name: 'سلامة الأغذية', global_num: 55, axis_order: 9, kpis: [{ ...VERIFICATION_KPI, description: 'فحوصات مخبرية دورية' }, { name: 'عدد العينات', target: 'دوري', unit: '-' }], documents: ['تقارير المختبر'] },
  // المحور 10: تخطيط الطوارئ (61–66)
  { title: 'وجود خطة محلية للاستعداد للطوارئ والكوارث', axis_name: 'تخطيط الطوارئ', global_num: 56, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'خطة استعداد للطوارئ' }, { name: 'تحديث الخطة', target: 'سنوي', unit: '-' }], documents: ['خطة الطوارئ'] },
  { title: 'تدريب المتطوعين على الإسعافات الأولية والإنقاذ', axis_name: 'تخطيط الطوارئ', global_num: 57, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'تدريب إسعافات أولية وإنقاذ' }, { name: 'نسبة المدربين', target: '100%', unit: '%' }], documents: ['سجل التدريب'] },
  { title: 'تحديد مناطق الإيواء والمجموعات الأكثر عرضة للخطر', axis_name: 'تخطيط الطوارئ', global_num: 58, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'مناطق إيواء ومجموعات معرضة' }, { name: 'توثيق التحديد', target: 'محدث', unit: '-' }], documents: ['خرائط الإيواء'] },
  { title: 'توفر نظام للإنذار المبكر في حالات الكوارث الطبيعية', axis_name: 'تخطيط الطوارئ', global_num: 59, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'نظام إنذار مبكر' }, { name: 'فعالية النظام', target: 'مختبر', unit: '-' }], documents: ['وصف النظام'] },
  { title: 'توفير مخزون احتياطي من الأدوية والمستلزمات الطبية للطوارئ', axis_name: 'تخطيط الطوارئ', global_num: 60, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'مخزون طوارئ أدوية ومستلزمات' }, { name: 'حد أدنى للمخزون', target: 'معتمد', unit: '-' }], documents: ['سجل المخزون'] },
  { title: 'إجراء تمارين محاكاة دورية لخطط الطوارئ', axis_name: 'تخطيط الطوارئ', global_num: 61, axis_order: 10, kpis: [{ ...VERIFICATION_KPI, description: 'تمارين محاكاة دورية' }, { name: 'عدد التمارين', target: '2+ سنوياً', unit: 'تمرين' }], documents: ['تقارير التمارين'] },
  // المحور 11: السلامة العامة (67–72)
  { title: 'توفير إضاءة كافية في الشوارع والأماكن العامة', axis_name: 'السلامة العامة', global_num: 62, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'إضاءة كافية' }, { name: 'نسبة التغطية', target: '90%+', unit: '%' }], documents: ['تقارير الصيانة'] },
  { title: 'صيانة الطرق وتوفير ممرات آمنة للمشاة', axis_name: 'السلامة العامة', global_num: 63, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'طرق وممرات آمنة' }, { name: 'نسبة الصيانة', target: 'دوري', unit: '-' }], documents: ['سجل الصيانة'] },
  { title: 'تطبيق معايير السلامة المرورية للحد من الحوادث', axis_name: 'السلامة العامة', global_num: 64, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'سلامة مرورية' }, { name: 'انخفاض الحوادث', target: '10%+', unit: '%' }], documents: ['تقارير الحوادث'] },
  { title: 'توفر مراكز للدفاع المدني والإطفاء وسهولة وصولها', axis_name: 'السلامة العامة', global_num: 65, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'مراكز دفاع مدني وإطفاء' }, { name: 'وقت الوصول', target: 'ضمن المعايير', unit: '-' }], documents: ['خريطة المراكز'] },
  { title: 'خفض معدلات الجريمة والعنف من خلال التوعية الأمنية', axis_name: 'السلامة العامة', global_num: 66, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'توعية أمنية لخفض الجريمة' }, { name: 'مؤشر الأمان', target: 'تحسن', unit: '-' }], documents: ['تقارير الأمان'] },
  { title: 'توفير بيئة آمنة للأطفال في الملاعب والحدائق', axis_name: 'السلامة العامة', global_num: 67, axis_order: 11, kpis: [{ ...VERIFICATION_KPI, description: 'بيئة آمنة للأطفال' }, { name: 'نسبة المواقع المطابقة', target: '90%+', unit: '%' }], documents: ['تقارير التقييم'] },
  // المحور 12: الرصد والتقييم (73–80)
  { title: 'وجود مؤشرات أداء واضحة لقياس تقدم البرنامج', axis_name: 'الرصد والتقييم', global_num: 68, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'مؤشرات أداء واضحة' }, { name: 'عدد المؤشرات', target: 'محدد', unit: '-' }], documents: ['قائمة المؤشرات'] },
  { title: 'إعداد تقارير دورية (ربع سنوية/سنوية) عن الإنجازات', axis_name: 'الرصد والتقييم', global_num: 69, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'تقارير دورية' }, { name: 'انتظام التقارير', target: 'ربع سنوي/سنوي', unit: '-' }], documents: ['التقارير'] },
  { title: 'إجراء تقييم ذاتي للمدينة باستخدام قائمة المعايير (75 معيار)', axis_name: 'الرصد والتقييم', global_num: 70, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'تقييم ذاتي بالمعايير الـ 75' }, { name: 'نسبة التحقق', target: 'مقيس', unit: '%' }], documents: ['تقرير التقييم'] },
  { title: 'توفر خرائط صحية للمدينة توضح توزيع الخدمات والفجوات', axis_name: 'الرصد والتقييم', global_num: 71, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'خرائط صحية' }, { name: 'تحديث الخرائط', target: 'دوري', unit: '-' }], documents: ['الخرائط'] },
  { title: 'مشاركة المجتمع في عملية رصد ومراقبة الخدمات', axis_name: 'الرصد والتقييم', global_num: 72, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'مشاركة المجتمع في الرصد' }, { name: 'نسبة المشاركة', target: '70%+', unit: '%' }], documents: ['سجل المشاركة'] },
  { title: 'استخدام نتائج التقييم في تعديل خطط العمل المستقبلية', axis_name: 'الرصد والتقييم', global_num: 73, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'استخدام التقييم في الخطط' }, { name: 'عدد التعديلات', target: 'سنوي', unit: '-' }], documents: ['محاضر التعديل'] },
  { title: 'تبادل الخبرات مع المدن الصحية الأخرى في الشبكة الوطنية', axis_name: 'الرصد والتقييم', global_num: 74, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'تبادل خبرات مع المدن الأخرى' }, { name: 'عدد الفعاليات', target: '2+ سنوياً', unit: 'فعالية' }], documents: ['سجل التبادل'] },
  { title: 'توثيق قصص النجاح والمبادرات المبتكرة ونشرها', axis_name: 'الرصد والتقييم', global_num: 75, axis_order: 12, kpis: [{ ...VERIFICATION_KPI, description: 'توثيق قصص النجاح والمبادرات' }, { name: 'عدد القصص/المبادرات', target: '2+ سنوياً', unit: '-' }], documents: ['المنشورات'] },
];
...
export const OVERALL_CLASSIFICATION_KPI = {
  ...
  unit: 'تحقق',
  description: 'يُحسب حسب نسبة المعايير التي وُجدت لها أدلة من إجمالي 75 معياراً.',
};

/**
 * استنتاج رقم المحور (1–12) من فهرس المعيار (0–74) حسب CSV.
 */
export function getAxisOrderFromStandardIndexCsv(index) {
  if (index < 0 || index >= 75) return 1;
  let sum = 0;
