...
/** مؤشرات أداء على مستوى كل محور (للتقارير) */
export const AXIS_KPIS_CSV = [
  { axis_order: 1, axis_name: 'تنظيم المدينة الصحية', axis_standards_count: 8, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '6 معايير على الأقل من 8', unit: 'معيار' }, { name: 'مؤشر أداء: انتظام الاجتماعات والميزانية', target: 'اجتماعات شهرية وميزانية معتمدة', unit: '-' }] },
  { axis_order: 2, axis_name: 'تعبئة المجتمع', axis_standards_count: 8, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '6 معايير على الأقل من 8', unit: 'معيار' }, { name: 'مؤشر أداء: تغطية المسح والمتطوعين', target: 'مسح 90%+ ومتطوعون لكل 50 عائلة', unit: '%' }] },
  { axis_order: 3, axis_name: 'التعاون بين القطاعات', axis_standards_count: 8, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '6 معايير على الأقل من 8', unit: 'معيار' }, { name: 'مؤشر أداء: عدد الشراكات والورش المشتركة', target: 'شراكات 2+ وورش 2+ سنوياً', unit: '-' }] },
  { axis_order: 4, axis_name: 'القروض الصغيرة', axis_standards_count: 5, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '4 معايير على الأقل من 5', unit: 'معيار' }, { name: 'مؤشر أداء: نسبة استرداد القروض', target: '90%+', unit: '%' }] },
  { axis_order: 5, axis_name: 'التعليم ومحو الأمية', axis_standards_count: 5, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '4 معايير على الأقل من 5', unit: 'معيار' }, { name: 'مؤشر أداء: الالتحاق ومحو الأمية', target: 'الالتحاق 100% وتقليل التسرب', unit: '%' }] },
  { axis_order: 6, axis_name: 'التنمية الصحية', axis_standards_count: 10, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '8 معايير على الأقل من 10', unit: 'معيار' }, { name: 'مؤشر أداء: التغطية بالتحصين والرعاية', target: 'تحصين 95%+ ورعاية حوامل 90%+', unit: '%' }] },
  { axis_order: 7, axis_name: 'المياه والصرف الصحي والبيئة', axis_standards_count: 8, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '6 معايير على الأقل من 8', unit: 'معيار' }, { name: 'مؤشر أداء: تغطية المياه والنظافة', target: 'مياه 90%+ ونظافة مقبولة', unit: '%' }] },
  { axis_order: 8, axis_name: 'الغذاء والبيئة', axis_standards_count: 4, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '3 معايير على الأقل من 4', unit: 'معيار' }, { name: 'مؤشر أداء: سلامة المنشآت الغذائية', target: 'امتثال 80%+', unit: '%' }] },
  { axis_order: 9, axis_name: 'سلامة الأغذية', axis_standards_count: 4, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '3 معايير على الأقل من 4', unit: 'معيار' }, { name: 'مؤشر أداء: التفتيش والفحوص المخبرية', target: 'تفتيش وفحوص دورية', unit: '-' }] },
  { axis_order: 10, axis_name: 'تخطيط الطوارئ', axis_standards_count: 6, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '5 معايير على الأقل من 6', unit: 'معيار' }, { name: 'مؤشر أداء: جاهزية الخطة والتمارين', target: 'خطة محدثة وتمارين 2+ سنوياً', unit: '-' }] },
  { axis_order: 11, axis_name: 'السلامة العامة', axis_standards_count: 6, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '5 معايير على الأقل من 6', unit: 'معيار' }, { name: 'مؤشر أداء: الإضاءة والطرق والأمان', target: 'تغطية 90%+ وتحسن مؤشر الأمان', unit: '%' }] },
  { axis_order: 12, axis_name: 'الرصد والتقييم', axis_standards_count: 8, kpis: [{ name: 'نسبة المعايير المحققة', target: '80% أو أكثر', unit: '%' }, { name: 'عدد المعايير ذات الأدلة', target: '6 معايير على الأقل من 8', unit: 'معيار' }, { name: 'مؤشر أداء: تقارير دورية وتقييم ذاتي', target: 'تقارير ربع سنوية وتقييم سنوي', unit: '-' }] },
];
