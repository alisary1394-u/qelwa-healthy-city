...
export const AXES_CSV = [
  { name: 'تنظيم المجتمع والتعبئة', description: '(أ) تنظيم المجتمع وتعبئته من أجل الصحة والتنمية (معايير 1–7)', order: 1 },
  { name: 'الشراكات والتعاون', description: '(ب) التعاون، والشراكة والدعوة بين القطاعات (معايير 8–14)', order: 2 },
...
const SHORT_TITLES_MAP = [
  // المحور 1: تنظيم المجتمع وتعبئته (1–7)
  ...
  // المحور 2: الشراكات والتعاون (8–14)
