...
/** المحاور الـ 9 حسب المرجع (أسماء مختصرة + وصف كامل من WHO) */
export const AXES_CSV = [
  { name: 'الشراكات والتعاون', description: '(أ) التعاون، والشراكة والدعوة بين القطاعات (معايير 1–7)', order: 1 },
  { name: 'تنظيم المجتمع والتعبئة', description: '(ب) تنظيم المجتمع وتعبئته من أجل الصحة والتنمية (معايير 8–14)', order: 2 },
  { name: 'المعلومات المجتمعية', description: '(ج) مركز المعلومات المجتمعي (معايير 15–19)', order: 3 },
  { name: 'المياه والبيئة والغذاء', description: '(د) المياه والصرف الصحي وسلامة الغذاء وتلوث الهواء (معايير 20–30)', order: 4 },
  { name: 'التنمية الصحية', description: '(هـ) التنمية الصحية (معايير 31–56)', order: 5 },
  { name: 'الطوارئ والاستجابة', description: '(و) الاستعداد للطوارئ والاستجابة لها (معايير 57–62)', order: 6 },
  { name: 'التعليم ومحو الأمية', description: '(ز) التعليم ومحو الأمية (معايير 63–67)', order: 7 },
  { name: 'المهارات والتدريب', description: '(ح) تنمية المهارات، والتدريب المهني وبناء القدرات (معايير 68–73)', order: 8 },
  { name: 'القروض الصغيرة', description: '(ط) أنشطة القروض الصغيرة (معايير 74–80)', order: 9 },
];
...
export const STANDARDS_CSV = [
  // المحور 1 (أ): التعاون، والشراكة والدعوة بين القطاعات (1–7)
  { title: 'تم ترشيح وتعيين أعضاء لجنة تنسيق أعمال المدينة الصحية بصورة رسمية من قبل مختلف القطاعات.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 1, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'ترشيح وتعيين أعضاء اللجنة رسمياً' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['قرارات الترشيح والتعيين'] },
  { title: 'تم تشكيل لجنة تنسيق أعمال المدينة الصحية تحت رئاسة العمدة أو المحافظ، واستقطبت أعضاءها من ممثلين من كافة القطاعات ذات الصلة، وسجلت جميع وقائع الاجتماعات والتبليغ بها.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 2, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'لجنة تحت رئاسة العمدة/المحافظ وسجلات الاجتماعات' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['محاضر الاجتماعات', 'سجل التبليغ'] },
  { title: 'تم تعيين منسق رسمي لبرنامج المدينة الصحية، مع توفير العدد الكافي من العاملين معه علاوة على مساحة معقولة للعمل من خلالها وتزويدها بالمعدات والتسهيلات.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 3, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'منسق رسمي ومساحة عمل ومعدات' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['قرار التعيين', 'وصف المساحة والمعدات'] },
  { title: 'يجتمع أعضاء الفريق المشترك بين القطاعات مع لجنة تنسيق أعمال المدينة الصحية ويقدمون المشورة الفنية والدعم للمجتمع.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 4, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'اجتماعات الفريق المشترك والمشورة والدعم' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['محاضر الاجتماعات', 'أدلة الدعم'] },
  { title: 'تم التعرف على الشركاء المحتملين والاتصال بهم وجاري تنفيذ مشروع واحد مشترك على الأقل في المكان الذي اختير ليكون مدينة صحية.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 5, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'شركاء محتملون ومشروع مشترك قيد التنفيذ' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['قائمة الشركاء', 'وثائق المشروع المشترك'] },
  { title: 'تسجيل القضايا المالية المتعلقة بالأنشطة المشتركة، ويتم تسجيلها والتبليغ بها، ويشارك المجتمع فيها من أجل تحقيق الشفافية.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 6, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'تسجيل وتبليغ القضايا المالية ومشاركة المجتمع' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['سجلات مالية', 'محاضر المشاركة'] },
  { title: 'يتم توثيق قصص النجاح، وتنشر وتستخدم في الدعوة، ووضع استراتيجية شاملة وآليات الدعوة مع مراعاة الثقافة المحلية، على أن تنفذ من قبل لجنة تنمية المجتمع المحلى.', axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', global_num: 7, axis_order: 1, kpis: [{ ...VERIFICATION_KPI, description: 'توثيق قصص النجاح واستراتيجية الدعوة' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['قصص النجاح', 'استراتيجية الدعوة'] },
  // المحور 2 (ب): تنظيم المجتمع وتعبئته من أجل الصحة والتنمية (8–14)
  { title: 'اختيرت ودربت المجموعات المكونة من الممثلين والمتطوعين على تقييم الاحتياجات، وترتيب الأولويات، وتحليل المعطيات، وإعداد المشروع، والرصد وآليات التسجيل وآليات الإبلاغ.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 8, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'تدريب المجموعات على التقييم والرصد والإبلاغ' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['أدلة التدريب', 'آليات التسجيل والإبلاغ'] },
  { title: 'تم تشكيل لجنة تنسيق أعمال المدينة الصحية، وسجلت من قبل السلطات المحلية، باعتبارها إحدى المنظمات المجتمعية أو المنظمات غير الحكومية، وتم توجيه الأعضاء نحو مهامهم ومسؤولياتهم.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 9, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'لجنة تنسيق مسجلة وأعضاء موجهون' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['سجل اللجنة', 'مهام ومسؤوليات الأعضاء'] },
  { title: 'المجموعات المكونة للممثلين والمتطوعين أصبحت شركاء نشيطين في التخطيط الصحي والاجتماعي المحلي والإجراءات. وفي إمكانهم تأمين الرعاية الصحية وغيرها من الخدمات الصحية التي تستخدم في هذه المجموعات.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 10, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'شراكة نشطة وقدرة على تأمين الخدمات' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['أدلة المشاركة', 'الخدمات المقدمة'] },
  { title: 'تقوم لجنة تنسيق أعمال المدينة الصحية بمراقبة المشاريع الاجتماعية والاقتصادية والإشراف عليها، وتسجل ما تم من إنجازات، وعراقيل وتحدد الحلول المحلية للمشكلات المحلية.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 11, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'مراقبة المشاريع وتسجيل الإنجازات والعراقيل' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['سجلات المراقبة', 'الإنجازات والحلول المحلية'] },
  { title: 'تبحث لجنة لتنسيق أعمال المدينة الصحية عن الموارد، وتقوم بتكوين العلاقات مع الشركاء المحتملين من أجل مزيد من التنمية في الأماكن المحلية.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 12, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'البحث عن الموارد والشراكات' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['أدلة الموارد والشراكات'] },
  { title: 'تم تأسيس أو تم التخطيط لإنشاء مركز اجتماعي من أجل الاستخدامات المختلفة وفقا لاحتياجات المجتمع (العقد اجتماعات المجتمع، وإجراء التدريب المهني، ويكون بمثابة مركزاً مجتمعيا للمعلومات، أو لتنظيم فعاليات ثقافية، محليه ووطنية ودينية، الخ)', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 13, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'مركز اجتماعي أو خطة لإنشائه' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['وثائق المركز أو الخطة'] },
  { title: 'تم تأسيس المجموعات النسائية والشبابية وتم تسجيلها وتسهم في التدخلات التنموية المحلية.', axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', global_num: 14, axis_order: 2, kpis: [{ ...VERIFICATION_KPI, description: 'مجموعات نسائية وشبابية مسجلة وفاعلة' }, { name: 'توفر الأدلة', target: 'أدلة متوفرة (+)', unit: 'تحقق' }], documents: ['سجل المجموعات', 'أدلة المساهمة'] },
...
export const AXIS_KPIS_CSV = [
  { axis_order: 1, axis_name: 'التعاون، والشراكة والدعوة بين القطاعات', axis_standards_count: 7, kpis: [{ name: 'نسبة المعايير المحققة في المحور (أدلة متوفرة)', target: '80% أو أكثر', unit: '%', description: 'عدد المعايير التي وُجدت لها أدلة ÷ 7' }, { ...DOCUMENTATION_KPI }, { name: 'عدد المعايير ذات الأدلة المتوفرة', target: '6 معايير على الأقل من 7', unit: 'معيار', description: 'حد التحقق: 80% من معايير المحور' }, { name: 'مؤشر أداء: لجنة التنسيق والمنسق والشركاء', target: 'أدلة متوفرة (+) أو غير متوفرة (-)', unit: '-' }] },
  { axis_order: 2, axis_name: 'تنظيم المجتمع وتعبئته من أجل الصحة والتنمية', axis_standards_count: 7, kpis: [{ name: 'نسبة المعايير المحققة في المحور (أدلة متوفرة)', target: '80% أو أكثر', unit: '%', description: 'عدد المعايير التي وُجدت لها أدلة ÷ 7' }, { ...DOCUMENTATION_KPI }, { name: 'عدد المعايير ذات الأدلة المتوفرة', target: '6 معايير على الأقل من 7', unit: 'معيار', description: 'حد التحقق: 80% من معايير المحور' }, { name: 'مؤشر أداء: تدريب المجموعات ولجنة التنسيق والمركز الاجتماعي', target: 'أدلة متوفرة (+) أو غير متوفرة (-)', unit: '-' }] },
...
/**
 * أسماء مختصرة للمعايير الـ 80 — تُعرض في رأس البطاقة، والتفاصيل الكاملة تبقى كما هي.
 */
const SHORT_TITLES_MAP = [
  // المحور 1: الشراكات والتعاون (1–7)
  'ترشيح أعضاء اللجنة رسمياً',
  'لجنة التنسيق تحت رئاسة المحافظ',
  'تعيين منسق رسمي للبرنامج',
  'اجتماعات الفريق المشترك بين القطاعات',
  'تنفيذ مشروع مشترك مع الشركاء',
  'الشفافية المالية والتبليغ',
  'توثيق قصص النجاح والدعوة',
  // المحور 2: تنظيم المجتمع وتعبئته (8–14)
  'تدريب المجموعات على التقييم والرصد',
  'تشكيل لجنة تنسيق المدينة الصحية',
  'شراكة المتطوعين في التخطيط الصحي',
  'مراقبة المشاريع وتسجيل الإنجازات',
  'البحث عن الموارد والشراكات',
  'إنشاء مركز اجتماعي مجتمعي',
  'تأسيس المجموعات النسائية والشبابية',
  // المحور 3: المعلومات المجتمعية (15–19)
  'تأسيس مركز المعلومات المجتمعي',
  'عرض ومشاركة المعلومات الأساسية',
  'استخدام المعلومات في الدعوة والرصد',
  'توثيق المسوح وتحديث البيانات',
  'تصميم وتحديث ملف المدينة',
  // المحور 4: المياه والبيئة والغذاء (20–30)
  'نظافة الموقع والمساحات الخضراء',
  'نظام معالجة النفايات الصلبة',
  'مخطط مصادر المياه وحمايتها',
  'مياه شرب آمنة وصرف صحي',
  'تدريب على البيئات الصحية',
  'سلامة الغذاء ومراقبة الأسواق',
  'الوصول لأسواق الأغذية الصحية',
  'حظر التدخين ومدينة خالية منه',
  'مركز جودة الهواء والمراقبة',
  'تدخلات الحد من تلوث الهواء',
  'تقييم أثر تلوث الهواء',
  // المحور 5: التنمية الصحية (31–56)
  'تدريب المتطوعين على القضايا الصحية',
  'تسجيل الولادات والوفيات',
  'نظم الإحالة المستدامة',
  'إشراك المجتمع في البحوث',
  'لجنة إدارة الرعاية الصحية',
  'توفر الأدوية واللقاحات',
  'تقييم جودة الخدمات الصحية',
  'رعاية ما قبل الولادة',
  'رعاية ما بعد الولادة',
  'تطعيم الأطفال دون السنة',
  'تسجيل المواليد والتحصين',
  'حملات استئصال شلل الأطفال',
  'رعاية الأطفال دون الخامسة',
  'مكافحة سوء التغذية ونقص الفيتامينات',
  'استراتيجية DOTS لعلاج السل',
  'برنامج مكافحة الملاريا',
  'الإبلاغ عن الأمراض المعدية',
  'التثقيف حول فيروس الإيدز',
  'متابعة مرضى الأمراض المزمنة',
  'دعم الصحة النفسية ومكافحة المخدرات',
  'دعم ذوي الإعاقة البدنية',
  'خفض مخاطر الحوادث والإصابات',
  'مكافحة الجريمة والعنف والتمييز',
  'برامج الطفولة المبكرة',
  'مبادرات الصحة المدرسية',
  'الصحة والسلامة المهنية',
  // المحور 6: الطوارئ والاستجابة (57–62)
  'توثيق حالات الطوارئ السابقة',
  'لجنة الاستعداد للطوارئ',
  'مخطط المدينة وحفظ النسخ',
  'التدريب على خطط الطوارئ',
  'الخطة الاحتياطية وإعلام المجتمع',
  'تحديد المجموعات المستضعفة',
  // المحور 7: التعليم ومحو الأمية (63–67)
  'التحاق جميع الأطفال بالمدارس',
  'تقييم جودة التعليم دورياً',
  'معايير جودة التعليم بالمدارس',
  'لجنة فرعية للتعليم والرصد',
  'مشاركة الشباب في محو الأمية',
  // المحور 8: المهارات والتدريب (68–73)
  'تقييم وتعزيز المهارات المحلية',
  'مراكز التدريب المهني',
  'قروض لطلبة التدريب المهني',
  'مراكز تدريب ذاتية التمويل',
  'مراكز الحاسوب واللغات والرياضة',
  'دعم المبدعين والمبتكرين',
  // المحور 9: القروض الصغيرة (74–80)
  'تحديد الفقراء وأولوية الإقراض',
  'ربط المهارات بالتدريب والإقراض',
  'تسجيل ومتابعة القضايا المالية',
  'نظام تسديد القروض',
  'الحساب المصرفي للجنة التنسيق',
  'نسبة خدمات القرض للتنمية',
  'ضمان السداد والصندوق الدائر',
];

// إضافة الاسم المختصر لكل معيار
STANDARDS_CSV.forEach((s, i) => { s.short_title = SHORT_TITLES_MAP[i] || s.title; });

/**
 * الحصول على الاسم المختصر للمعيار من رمزه (م1-1 … م9-7)
 */
export function getShortTitleByCode(code) {
  const idx = getStandardIndexFromCode(code);
  return idx >= 0 && STANDARDS_CSV[idx]?.short_title ? STANDARDS_CSV[idx].short_title : null;
}
