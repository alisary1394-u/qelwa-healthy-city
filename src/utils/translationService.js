...
const BUILTIN_TRANSLATIONS = {
  'ar>en': {
    ...
    // ─── Standards-Enhanced page labels ──────────────────────
    'القيمة': 'Value',
    'الهدف': 'Target',
    'الإنجاز': 'Achievement',
    'الوزن': 'Weight',
    ...
    'المعايير والمؤشرات': 'Standards & Indicators',
    'معيار جديد': 'New Standard',
    'جميع المحاور': 'All Axes',
    'لا توجد معايير': 'No Standards',
    'إضافة معيار جديد': 'Add New Standard',
    'تحديث قيم المؤشرات': 'Update Indicator Values',
    'تحديث قيم مؤشرات الأداء': 'Update KPI Values',
    'رفع دليل': 'Upload Evidence',
    'الأدلة المرفوعة': 'Uploaded Evidence',
    'الأدلة المطلوبة': 'Required Evidence',
    'رفع دليل للمعيار': 'Upload Evidence for Standard',
    'عنوان الدليل': 'Evidence Title',
    'وصف الدليل': 'Evidence Description',
    'جاري الرفع...': 'Uploading...',
    'رفع مرفقات للمؤشر': 'Upload Attachments for Indicator',
    'إضافة محور جديد': 'Add New Axis',
    'اسم المحور': 'Axis Name',
    'وصف المحور': 'Axis Description',
    'رمز المعيار': 'Standard Code',
    'عنوان المعيار': 'Standard Title',
    'وصف المعيار': 'Standard Description',
    'حالة التحقق والمستندات': 'Verification & Documents Status',
    'اكتمال المستندات': 'Document Completion',
    'المستندات المفقودة': 'Missing Documents',
    'لا توجد مؤشرات أداء محددة لهذا المعيار': 'No KPIs defined for this standard',
    'لا توجد مؤشرات لهذا المعيار': 'No indicators for this standard',
    'لا توجد مؤشرات مسجلة لهذا المعيار.': 'No registered indicators for this standard.',
    // ─── WHO Report missing labels ──────────────────────────
    'إعداد التقرير': 'Report Preparation',
    'المعايير المكتملة': 'Completed Standards',
    'إجمالي المعايير': 'Total Standards',
    'التقدم حسب المحاور': 'Progress by Axes',
    'المسؤول': 'Responsible',
    'الأدلة المرفقة': 'Attached Evidence',
    'مرفوض': 'Rejected',
    'قيد المراجعة': 'Under Review',
    'التوصيات والخطوات القادمة': 'Recommendations & Next Steps',
    'المعايير التي تحتاج إلى إكمال': 'Standards That Need Completion',
    'التوصيات العامة': 'General Recommendations',
    'مراجعة المعايير غير المكتملة وتحديد الموارد اللازمة': 'Review incomplete standards and identify required resources',
    'تعزيز التوثيق وجمع الأدلة للمعايير قيد التنفيذ': 'Strengthen documentation and collect evidence for in-progress standards',
    'تحديث خطة العمل بناءً على التقدم الحالي': 'Update action plan based on current progress',
    'التنسيق مع جميع اللجان لضمان استكمال المتطلبات': 'Coordinate with all committees to ensure completion of requirements',
    'هذا التقرير معد وفقاً لمعايير المدن الصحية (مرجع المعايير) — 9 محاور و 80 معياراً': 'This report is prepared according to Healthy Cities Standards — 9 Axes & 80 Standards',
    'للمزيد من المعلومات': 'For more information',
    // ─── Dashboard / Layout labels ──────────────────────────
    'مدينة قلوة الصحية': 'Qelwa Healthy City',
    'مستخدم': 'User',
    'مصروف': 'Expense',
    // ─── Budget / Transaction labels ────────────────────────
    'رعاية': 'Sponsorship',
    'تبرع': 'Donation',
    'دعم حكومي': 'Government Support',
    ...
    'بطاقة': 'Card',
    'تخصيص عام': 'General Allocation',
    'مبادرات': 'Initiatives',
    'تشغيل المبادرات': 'Initiative Operations',
    'دفعات مجدولة': 'Scheduled Payments',
    'صرف تشغيلي': 'Operational Expenditure',
    'دفعة معلقة': 'Pending Payment',
    'مبادرة': 'Initiative',
    'ميزانية سنوية تشغيلية': 'Annual Operational Budget',
    'الإيرادات': 'Revenue',
    'المصروفات': 'Expenses',
    'الميزانية': 'Budget',
    'إجمالي الإيرادات': 'Total Revenue',
    'إجمالي المصروفات': 'Total Expenses',
    'صافي الميزانية': 'Net Budget',
    // ─── Initiative titles (seed data) ──────────────────────
    'برنامج الفحص الدوري للأمراض المزمنة': 'Chronic Disease Periodic Screening Program',
    'مبادرة الصحة النفسية': 'Mental Health Initiative',
    'مشروع تحسين جودة الهواء': 'Air Quality Improvement Project',
    'حملة النظافة الشاملة': 'Comprehensive Cleanliness Campaign',
    'برنامج التوعية بأضرار التدخين': 'Anti-Smoking Awareness Program',
    'مبادرة الصحة المدرسية': 'School Health Initiative',
    'حملة التوعية بالأمراض المعدية': 'Infectious Disease Awareness Campaign',
    'مسابقة المشي اليومي': 'Daily Walking Challenge',
    'إنشاء مسارات رياضية': 'Sports Trails Construction',
    'برنامج الرياضة للجميع': 'Sports for All Program',
    'برنامج التغذية المدرسية الصحية': 'Healthy School Nutrition Program',
    'حملة الحد من السمنة': 'Obesity Reduction Campaign',
    'مبادرة الطبخ الصحي': 'Healthy Cooking Initiative',
    // ─── WHO-based committee names ──────────────────────────
    'لجنة تنظيم المدينة الصحية': 'Healthy City Organization Committee',
    'لجنة تعبئة المجتمع': 'Community Mobilization Committee',
    'لجنة التعاون بين القطاعات': 'Inter-Sectoral Cooperation Committee',
    'لجنة القروض الصغيرة': 'Microloans Committee',
    'لجنة التعليم ومحو الأمية': 'Education & Literacy Committee',
    'لجنة التنمية الصحية': 'Health Development Committee',
    'لجنة المياه والصرف الصحي والبيئة': 'Water, Sanitation & Environment Committee',
    'لجنة الغذاء والبيئة': 'Food & Environment Committee',
    'لجنة سلامة الأغذية': 'Food Safety Committee',
    'لجنة تخطيط الطوارئ': 'Emergency Planning Committee',
    'لجنة السلامة العامة': 'Public Safety Committee',
    'لجنة الرصد والتقييم': 'Monitoring & Evaluation Committee',
    'لجنة المعلومات المجتمعية': 'Community Information Committee',
    // ─── Volunteer opportunity titles ────────────────────────
    'دعم أعمال': 'Support work of',
    // ─── Common additional labels ───────────────────────────
    'المحاسب': 'Accountant',
    'الموظف المالي': 'Financial Officer',
...
function builtinLookup(text, from, to) {
  const key = `${from}>${to}`;
  const dict = BUILTIN_TRANSLATIONS[key];
  if (!dict) return null;
  // Exact match first
